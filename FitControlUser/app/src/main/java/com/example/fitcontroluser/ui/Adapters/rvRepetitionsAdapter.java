...
public class rvRepetitionsAdapter extends RecyclerView.Adapter<rvRepetitionsAdapter.MyViewHolder> {

    public interface OnClickListener {
        void onArticleClick(String value);
    }

    public static rvRepetitionsAdapter.OnClickListener mListener;

    public void setClickArticleListener(rvRepetitionsAdapter.OnClickListener listener) {
    ...
    public rvRepetitionsAdapter(Context context, List<Repetition> mInventoryList) {
    ...
    @NonNull
    @Override
    public rvRepetitionsAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        //HERE
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_movement_reps, parent, false);
        rvRepetitionsAdapter.MyViewHolder holder = new rvRepetitionsAdapter.MyViewHolder(view);
    ...
    @Override
    public void onBindViewHolder(@NonNull final rvRepetitionsAdapter.MyViewHolder holder, final int position) {
